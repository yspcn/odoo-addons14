...
'use strict';
    ...
    publicWidget.registry.popupEditorEpt = publicWidget.Widget.extend({
		...
		edit_events: {
			'click .hotspot_element, img.o_we_selected_image' : 'showHotspotPopup', // Show The Hotspot Configuration Popup
        ...
        _saveHotspot: function (str) {
            ...
            self.element_selector.attr('data-action',$('#hotspot_action a.active').data('action'))
